...
@section('content')
    @include('users.partials.header', ['title' => __('Add Public Holiday')])   
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">                                   
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Public Holiday') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('publicholiday.store')}}" autocomplete="off">
