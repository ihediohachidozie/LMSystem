...
{{--                             <small>
                            ...
                            <br>
                             <small>
                                {{ __('Username') }} <strong>admin@argon.com/Admin</strong>
                        ...
                        <form role="form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group{{ $errors->has('username') ? ' has-danger' : '' }} mb-3">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" placeholder="{{ __('Username') }}" type="text" name="username" value="{{ old('username') }}" required autofocus autocomplete="off">
                                </div>
