                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">Leave Applications</h5>
                                    <span class="h2 font-weight-bold mb-0">{{ $leaves->count() }}</span>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0">{{ $departments->count() }}</span>
                                </div>
                                <div class="col-auto">
